...
public class RedisUtil {
    ...
    public <T> ListOperations<String, T> setList(String key, List<T> list) {
        ...
        if (list.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                listOperation.leftPush(key, list.get(i));
            }
        }
    ...
    public <T> ListOperations<String, T> resetList(String key, List<T> list) {
    ...
    public String lRightPopAndLeftPush(String sourceKey, String destinationKey) {
        return redisTemplate.opsForList().rightPopAndLeftPush(sourceKey, destinationKey).toString();
    }
